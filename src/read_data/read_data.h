...
/*!
    ...
    class ReadData{
        ...
        vec_d res_voltages_max;                 ///максимальные значения резистивных напряжений для полоидальных катушек, имеющих собственное сопротивление (Вольт):
    ...
    public:
        ...
        */
        ...
        /*!
        Возвращает максимальные значения резистивных напряжений для полоидальных катушек, имеющих собственное сопротивление (Вольт).
        \param[out] vec_d &vec вектор, в который записываются данные значения
        */
        void get_res_voltages_max(vec_d& vec) const {
            vec = res_voltages_max;
        }
        /*!
